...
def config(**kwargs):
    ...
    sim = ph.Simulation(
        ...
        cells=33,  # what is the k of the most unstable ES mode ? gary has the answer ?
        dl=0.2,
    ...
    ph.MaxwellianFluidModel(
        ...
        by=by,
        bz=bz,
        main={"charge": 1, "density": densityMain, "nbr_part_per_cell": 500, **vMain},
        beam={"charge": 1, "density": densityBeam, "nbr_part_per_cell": 500, **vBulk},
    )
...
def main():
    Simulator(config(diagdir="ib3")).run()
